    ...
    <>
      <div id="Contact" className="main footer max-w-6xl mx-auto  p-4 my-32 ">
        <div className="  sm:flex gap-10">
          <div className="footer left w-full sm:w-1/4 ">
          ...
          <div className="footer flex-wrap w-full sm:flex sm:w-3/4 ">
        ...
        <div className=" sm:flex justify-between">
          <div>
            {" "}
            <h1 className="ml-16">Designed and Developed by UIdeck</h1>
          </div>
          <div className=" ml-32">
      ...
      <div className="w-full text-center sm:w-1/3 ">
        ...
        <ul className="">
          {link.map((item, index) => (
            <li
              key={index}
              className="my-2 text-gray-500 text-lg hover:text-yellow-500"
            >
              {" "}
              {item}
            </li>
